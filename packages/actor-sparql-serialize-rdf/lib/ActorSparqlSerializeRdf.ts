...
export class ActorSparqlSerializeRdf extends ActorSparqlSerialize implements IActorSparqlSerializeRdfArgs {
  ...
  public async testHandle(action: IActorQueryOperationOutput, mediaType: string, context?: ActionContext): Promise<IActorTest> {
  ...
  public async runHandle(action: IActorQueryOperationOutput, mediaType: string, context?: ActionContext): Promise<IActorSparqlSerializeOutput> {
