...
export class ActorRdfResolveHypermediaQpf extends ActorRdfResolveHypermedia
  ...
  protected createSource(metadata: {[id: string]: any}, context?: ActionContext, quads?: RDF.Stream): RdfSourceQpf {
    return new RdfSourceQpf(this.mediatorMetadata, this.mediatorMetadataExtract, this.mediatorRdfDereference, this.subjectUri, this.predicateUri, this.objectUri, this.graphUri, metadata, context, quads);
  }
}
